...
SECRET_KEY = 'django-insecure-j1b(^m4qrzjx=kjx173nvh$2dtdp(ltm^ex1c@*cq-pq+3-q34'
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PERMISSION_CLASSES': [
        'rest_framework.permissions.IsAuthenticated',  # Default: Users must be authenticated
    ],
}
